...
* Validation error was thrown when running a plugin locally that registers items with long names

## 1.1.0 - 2026-01-27

### Added

* Allow plugins to define (external) dependencies

### Changed

* Set target to net10.0
