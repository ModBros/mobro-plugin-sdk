...
dotnet build --framework net10.0 --runtime win-x64 --no-self-contained --configuration Release .\SDK.Core\
dotnet build --framework net10.0 --runtime win-x64 --no-self-contained --configuration Release .\SDK\
